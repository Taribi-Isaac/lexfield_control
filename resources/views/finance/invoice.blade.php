...
<body>
    ...
    <div class="section">
        ...
        <div class="totals">
            ...
            <div class="total"><strong>Total: {{ number_format((float) $invoice->total, 2) }}</strong></div>
        </div>
    </div>
    ...
    <div class="footer">
        Prepared by {{ $invoice->createdBy?->name ?? '—' }} · Mon–Fri 9:00AM–5:00PM
    </div>
</body>
</html>
