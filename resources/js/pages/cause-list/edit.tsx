...
export default function CauseListEdit({
    entry,
    lawyers,
}: {
    ...
    const update = CauseListController.update({ cause_list: entry.id });
                            ...
                            <div className="grid gap-2 md:grid-cols-2">
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        id="suit_number"
                                        name="suit_number"
                                        defaultValue={entry.suit_number ?? ''}
                                    />
